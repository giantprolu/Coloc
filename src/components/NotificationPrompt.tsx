			...
			<div className="rounded-xl border bg-white shadow-lg p-4 flex items-start gap-3">
				...
				<div className="flex-1 min-w-0">
					...
					<p className="text-xs text-gray-500 mt-0.5">
						Recevez les messages du chat, les mentions et les alertes de la
						coloc.
					</p>
					<div className="flex gap-2 mt-2">
						<button
							...
							disabled={loading}
							className="rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-medium text-white active:bg-indigo-700 disabled:opacity-50"
						>
